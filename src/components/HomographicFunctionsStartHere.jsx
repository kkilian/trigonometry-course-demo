        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          {onBack && (
            <div className="mb-4">
              <button
                onClick={onBack}
                className="inline-flex items-center gap-2 px-4 py-2 text-sm text-stone-600 hover:text-stone-900"
              >
            ...
            <div className="flex flex-wrap items-center gap-2 mt-4">
              ...
              {showAllProblems && !showSearch && (
                <button
                  ...
                  className="px-8 py-2.5 rounded-full text-sm font-medium transition-all inline-flex items-center gap-2 bg-transparent text-stone-500 hover:text-stone-700"
                >
              ...
              {problemsToShow.length === 1 ? (
                ...
                <div className="px-4">
                  ...
                  <button
                    ...
                    className={`w-full text-left p-10 rounded-xl transition-colors ${
                  ...
                  >
                    <div className="flex items-center justify-between gap-8">
                      <div className="flex-1">
                        <div className="text-stone-900 text-2xl leading-relaxed font-medium">
                  ...
                  <div className="space-y-4 px-4">
                    {problemsToShow.map((problem, index) => (
                      <button
                        key={problem.id}
                        onClick={() => handleStartProblem(problem)}
                        className={`w-full text-left p-8 rounded-xl transition-colors ${
                          completedProblems.has(problem.id)
                            ? 'bg-orange-50 border-2 border-orange-200 hover:border-orange-300'
                            : index === 0
                              ? 'bg-white border-2 border-stone-200 hover:border-stone-300'
                      ...
                      >
                        <div className="flex items-center justify-between gap-4">
                          <div className="flex-1">
                            ...
                            <div className="text-stone-900 text-lg leading-relaxed font-medium">
                              <MathRenderer content={problem.statement || ''} />
                            </div>
                          </div>
